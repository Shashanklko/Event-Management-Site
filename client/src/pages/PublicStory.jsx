...
const PublicStory = ({ activeChapter, setActiveChapter }) => {
  ...
  useEffect(() => {
    const handleWheel = (e) => {
      ...
      if (selectedEvent || selectedMember || rsvpEvent || lightboxIndex !== null || e.target.closest('.no-page-turn')) return;
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (selectedEvent || selectedMember || rsvpEvent || lightboxIndex !== null || document.querySelector('.no-page-turn')) return;
  ...
  const renderChapter = () => {
    switch (activeChapter) {
      ...
      case 5: return <Chapter6_Team team={team} onSelectMember={setSelectedMember} />;
